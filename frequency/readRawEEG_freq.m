...
%                             useConditions =  settings.useCnds;
%                             sensorData(s, useConditions) = signalData(useConditions)';
%                             cellNoiseData1(s, useConditions) = noise1(useConditions)';
%                             cellNoiseData2(s, useConditions) = noise2(useConditions)';         
%                         else
%                         
